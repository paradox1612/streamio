      ...
      >
        <div className="panel p-7 sm:p-10">
          ...
          <div className="mt-8 mb-7">
            ...
            <h1 className="text-center text-2xl font-bold text-white sm:text-3xl">Reset your password</h1>
          ...
          {sent ? (
            <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }} className="text-center">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-300/65">If that address exists in our system, a reset link has been sent.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input id="reset-email" type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" autoComplete="email" name="email" />
              </div>
