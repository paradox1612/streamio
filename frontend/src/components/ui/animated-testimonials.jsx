...
export function AnimatedTestimonials({
  ...
  return (
    <div
      className={cn(
        'mx-auto w-full max-w-6xl px-4 py-12 md:px-8 lg:px-12 lg:py-16',
        className
      )}
    >
      <div className="relative grid grid-cols-1 gap-10 md:grid-cols-[0.9fr_1.1fr] md:gap-16">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5">
                    <p className="text-xs font-semibold uppercase tracking-[0.24em] text-sky-100/55">
                      {testimonial.metric}
                    </p>
                    <p className="mt-2 max-w-xs text-sm leading-6 text-slate-200/78">
                      {testimonial.context}
                    </p>
                  </div>
                </motion.div>
        ...
        <div className="flex flex-col justify-between py-2">
          ...
          >
            ...
            <p className="mt-2 text-sm text-slate-300/62">
