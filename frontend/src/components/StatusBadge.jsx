...
/**
 * StatusBadge — enhanced with Sera UI animated-badge style.
 * Keeps the original color palette; adds a live ring-pulse on "online".
 */
const pulseCss = `
...
export default function StatusBadge({ status = 'unknown', pulse = false, size = 'md' }) {
